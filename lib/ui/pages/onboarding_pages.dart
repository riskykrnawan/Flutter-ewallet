                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: currentIndex == 0 ? lightblueColor : lightBackgroundColor
                      ),
                    ),
                    Container(
                      width: 12,
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        color: currentIndex == 1 ? lightblueColor : lightBackgroundColor
                      ),
                    ),
                    Container(
                      width: 12,
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        color: currentIndex == 2 ? lightblueColor : lightBackgroundColor
                      ),
                    ),
                    const Spacer(),
                    CustomFilledButton(
